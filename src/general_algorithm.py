...
def run_ga():
    ...
    worksheet.append(("Function","Number of Generation","Mutation Probability","Crossover Type", "Selection Type", "Best Fitness", "Best Average Fitness", "Std_Dev Fitness"))
                    ...
                    for crossover_type in crossover_types:
                        for selection_type in selection_types:
                            for i in range(num_of_run):
                                ...
                                result = GA.GA(obj_func, -500, 500, dim, pop_size, num_of_gen,mut_prob,crossover_type,selection_type)
                                results.append(result.best)
                        
                            avg     = statistics.mean(results)
                            std_dev = statistics.stdev(results)
                            worksheet.append((arr_functions(func).name, num_of_gen,
                            mut_prob,crossover_types(crossover_type).name, 
...
def run_sa():
    ...
    worksheet.append(("Function","Initial Temperature","Decrease Temperature Type", "Best Fitness", "Best Average Fitness", "Std_Dev Fitness"))
    ...
    for func in arr_functions:
        for initial_temp in initial_temps:
            for decrease_temp_type in decrease_temp_types:
                for i in range(num_of_run):
                    obj_func = functions.selectFunction(func)
                    result = SA.simulated_annealing(min_values = [-500 for _ in range(dim)], 
...
def run_gwo():
    ...
    worksheet.append(("Function","Population Size","Number of Generations", "Best Fitness", "Best Average Fitness", "Std_Dev Fitness"))
    ...
    for func in arr_functions:
        for pop_size in pop_sizes:
            for num_of_gen in num_of_generations:
                for i in range(num_of_run):
                    obj_func = functions.selectFunction(func)
                    result = GWO.GWO(obj_func, -65536, 65536, dim, pop_size, num_of_gen)
                    results.append(result.best)
...
def run_hc():
    ...
    worksheet.append(("Function","Number of Generations", "Best Fitness", "Best Average Fitness", "Std_Dev Fitness"))
...
def run_hs():
    ...
    worksheet.append(("Function","HMS", "BW","HMCR","PAR","Best Fitness", "Best Average Fitness", "Std_Dev Fitness"))
