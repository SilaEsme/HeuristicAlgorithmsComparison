...
# SA Function
def simulated_annealing(min_values = [-5,-5], max_values = [5,5], mu = 0, sigma = 1, initial_temperature = 1.0, final_temperature = 0.0001, alpha = 0.9, target_function = target_function, verbose = True, decrease_type = enumDecreaseTemp.DecreaseTypes.arithmetic):    
    ...
    while (Temperature > final_temperature):
        ...
        if decrease_type == enumDecreaseTemp.DecreaseTypes.geo:
